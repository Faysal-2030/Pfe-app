...
public class UserService implements IUserService {
    ...
    public User registerNewUserAccount(final UserDto accountDto) {
        ...
        user.setRoles(new ArrayList<>(Arrays.asList(roleRepository.findByName("ROLE_CLIENT"))));
    ...
    // @Transactional // Use read-only for fetching data
    // public Optional<Projet> getUnpaidProject(Long userId) {
    // User user = userRepository.findById(userId).orElse(null); // Fetch the user
    // if (user != null) {
    // // Return the first unpaid project, if it exists
    // return user.getProjets().stream()
    // .filter(projet -> projet.getPaymentStatus() == PaymentStatus.NOT_PAID)
    // .findFirst();
    // }
    ...
    public List<User> getAllAdmins() {
        // Fetch users who have the 'ROLE_ADMIN' role
